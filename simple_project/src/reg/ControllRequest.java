...
//		out.print(user.toString());
		...
		rd.include(request,response);
			...
			rd.include(request, response);
			}else if(res.getUsername().equals("mash")){
				
				rdx = request.getRequestDispatcher("NewController");
...
//				rd.include(request, response);
			...
			UserDao ud= new UserDao();
			String res = ud.updatex(uname, pass);
			System.out.print(res);
			rdx=request.getRequestDispatcher("login.jsp");
